...
if(isset($_POST['insert']))
{
    ...
    $query = "INSERT INTO poetry(title,author,summary,main_post,dt,picture) Values ('$title', '$author', '$summary', '$main_post','$dt','$image')";
    if($mysqli->query($query) or die($mysqli->error))
    {
        if(move_uploaded_file($_FILES['image']['tmp_name'], $target))
        {
        echo "<script>alert('poetry Post Created Succesfully')</script>";
        }
        else
        {
            ...
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                ...
                                <p class="pageheader-text">Edit poetry</p>
                    ...
                    <div class="row">
                     <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    <h5 class="card-header">Create New poetry Post</h5>
                                    <div class="card-body">
                                        <form method="post" action="poetry.php" enctype="multipart/form-data">
                                            <div class="form-group">
                                                <label for="inputText3" class="col-form-label">Title</label>
                                                <input id="inputText3" type="text" class="form-control" name="title">
                                            </div>
                                            <div class="form-group">
                                                <label for="inputText3" class="col-form-label">Poetry Author</label>
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div>
                                                <a href = "edit.php?poetry=<?php echo urlencode($row['id']); ?>"><img src='images/<?php echo $row['picture']?>' alt="user" class="rounded" width="100%"></a>
                                                </div>
                                            </div>
                                            ...
                                            <a href = "delete.php?poetryid=<?php echo  urlencode($row['id']); ?>" onclick="return confirm('Are you sure you want to delete this picture?');">Delete Post</a>
                                            </div>
                                        </div>
                                </div>
